...
import {cancelOrderSnUsingPOST} from "@/services/kaiapi-order/orderController";
import {aliPayUsingPOST} from "@/services/kaiapi-third-part/payController";
const { Countdown } = Statistic;
const Order: React.FC = () => {
  const [orderData,setOrderData] = useState<API.OrderVo>()
  ...
  const createAlipay =async () =>{
    const res = await aliPayUsingPOST({subject:orderData?.name,totalAmount:orderData?.totalAmount,traceNo:orderData?.orderSn})
