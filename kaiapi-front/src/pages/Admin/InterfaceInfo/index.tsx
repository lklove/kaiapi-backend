...
import {
  ...
  deleteInterfaceInfoUsingPOST, listInterfaceInfoAllByPageUsingGET,
  listInterfaceInfoByPageUsingGET,
  offlineUsingPOST,
  publishUsingPOST,
  updateInterfaceInfoUsingPOST
} from "@/services/kaiapi-backend/interfaceInfoController";
    ...
    <PageContainer>
      <ProTable<API.RuleListItem, API.PageParams>
        ...
        request={async (
          ...
          const res = await listInterfaceInfoAllByPageUsingGET({...params, ...sort});
          if (res?.data) {
            return {
