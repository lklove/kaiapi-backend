...
/** addUserInterfaceByFeign POST /api/userInterfaceInfo/feign/add */
export async function addUserInterfaceByFeignUsingPOST(
  body: API.AddUserInterfaceTo,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/userInterfaceInfo/feign/add', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** listUserInterfaceLeftNumByPage GET /api/userInterfaceInfo/getUserInterfaceLeftNum */
export async function listUserInterfaceLeftNumByPageUsingGET(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.listUserInterfaceLeftNumByPageUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageInterfaceLeftVo>(
    '/api/userInterfaceInfo/getUserInterfaceLeftNum',
    {
      method: 'GET',
      params: {
        ...params,
...
export async function listUserInterfaceInfoByPageUsingGET(
  ...
  return request<API.BaseResponsePageUserInterfaceInfoVO>('/api/userInterfaceInfo/list/page', {
    method: 'GET',
    params: {
      ...params,
    },
